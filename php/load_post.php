...
/*	while ($row = $stmt->fetch()) {
    ...
    foreach ($result as $post)
    {
        ...
        echo '</div><!-- post -->';
        echo "<button class=\"button\" id=\"next_btn\" autofocus onkeyup=\"feedBtnNext(event, $previous)\" onclick=\"feedBtnNext(event, $previous)\">Next</button>";  
        echo '</div>';
                    ...
                    echo '</div>';
      //  echo "<button type=\"button\" onclick=\"loadFeed($previous)\">test</button>";        
    }
